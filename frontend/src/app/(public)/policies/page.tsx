export default function PoliciesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="font-heading text-3xl font-bold mb-10">How Sarelle Works</h1>
      ...
      <div className="space-y-12 text-wimc-muted">
        <section>
          ...
          <div className="space-y-3 text-sm leading-relaxed">
            <p>Every item sold on Sarelle goes through our professional hub. We handle pickup, authentication, photography, and shipping so you can buy and sell with complete confidence.</p>
